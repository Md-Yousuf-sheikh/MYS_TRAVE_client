...
const Login = () => {
    const { setError, setUser, sinInUsingGoogle } = useAuth();
    ...
    return (
        <section class="min-screen flex items-stretch text-white ">
            ...
            <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style={{ "background-color": " #161616" }}>
                ...
                <div class="w-full py-6 z-20">
                    <h1 class="my-6 text-4xl font-bold">
                        MYS <span className="text-red-400">TRAVEL</span>
                    </h1>
                    <div class="py-6 space-x-2">
                        ...
                        <span onClick={handelGoogleSinIn} class="w-10 h-10 items-center justify-center inline-flex rounded-full font-bold text-lg border-2 border-white">G</span>
